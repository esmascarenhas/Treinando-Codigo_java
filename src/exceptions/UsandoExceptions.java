    ...
    public static void main(String[] args) {
        ...
        public static void adicionarContato (Scanner scan, Agenda agenda){
            try {
                ...
                String nome = lerInformacoesString(scan, "Entre com o nome do contato. ");
                String telefone = lerInformacoesString(scan, "informe o telefone pra contato. ");
                String email = lerInformacoesString(scan, "Entre com o e-mail do contato. ");
        ...
        public static String lerInformacoesString (Scanner scan, String msg){
